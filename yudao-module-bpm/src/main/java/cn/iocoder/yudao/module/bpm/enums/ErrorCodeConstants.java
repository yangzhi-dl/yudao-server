...
public interface ErrorCodeConstants {
    ...
    // ========== ACL 授权审批 1-009-015-000 ==========
    ErrorCode ACL_APPROVAL_NOT_EXISTS = new ErrorCode(1_009_015_000, "ACL 授权审批单据不存在");
    ErrorCode ACL_APPROVAL_OPERATION_TYPE_INVALID = new ErrorCode(1_009_015_001, "ACL 授权审批的操作类型不正确");
