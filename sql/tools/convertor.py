...
or with uv
uv run --with simple-ddl-parser convertor.py postgres ../mysql/dzint-nexus-pro.sql > ../postgresql/dzint-nexus-pro.sql
uv run --with simple-ddl-parser convertor.py sqlserver ../mysql/dzint-nexus-pro.sql > ../sqlserver/dzint-nexus-pro.sql
uv run --with simple-ddl-parser convertor.py kingbase ../mysql/dzint-nexus-pro.sql > ../kingbase/dzint-nexus-pro.sql
uv run --with simple-ddl-parser convertor.py opengauss ../mysql/dzint-nexus-pro.sql > ../opengauss/dzint-nexus-pro.sql
uv run --with simple-ddl-parser convertor.py highgo ../mysql/dzint-nexus-pro.sql > ../highgo/dzint-nexus-pro.sql
uv run --with simple-ddl-parser convertor.py oracle ../mysql/dzint-nexus-pro.sql > ../oracle/dzint-nexus-pro.sql
uv run --with simple-ddl-parser convertor.py dm8 ../mysql/dzint-nexus-pro.sql > ../dm/ruoyi-vue-pro-dm8.sql
"""
...
def main():
    ...
    parser.add_argument(
        ...
        help="源数据库脚本路径",
        nargs="?",
        default="../mysql/dzint-nexus-pro.sql"
    )
