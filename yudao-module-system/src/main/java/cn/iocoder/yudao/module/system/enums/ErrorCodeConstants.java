...
public interface ErrorCodeConstants {
    ...
    // ========== ACL 权限模块 1-002-030-000 ==========
    ErrorCode ACL_PRINCIPAL_TYPE_NOT_ALLOWED = new ErrorCode(1_002_030_000, "当前用户无权使用【{}】授权主体");
    ErrorCode ACL_AUTH_PERMISSION_NOT_ALLOWED = new ErrorCode(1_002_030_001, "当前用户无该资源的 ACL 授权权限，无法进行权限管理");
    ErrorCode ACL_PERMISSION_NOT_OWNED = new ErrorCode(1_002_030_002, "当前用户未持有【{}】权限，无法进行授权");
    ErrorCode ACL_EXPIRE_TIME_EXCEED_PARENT = new ErrorCode(1_002_030_003, "授权过期时间不能晚于上一级授权的过期时间");
    ErrorCode ACL_EXPIRE_TIME_BEFORE_NOW = new ErrorCode(1_002_030_004, "授权过期时间不能早于当前时间");
    ErrorCode ACL_DIRECT_OPERATION_NOT_ALLOWED = new ErrorCode(1_002_030_005, "ACL 授权操作已强制走 OA 审批，请调用审批创建接口（/bpm/acl/permission-approval/create）");
