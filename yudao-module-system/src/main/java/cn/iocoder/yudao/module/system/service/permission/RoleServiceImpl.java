...
public class RoleServiceImpl implements RoleService {
    ...
    public Long createRole(RoleSaveReqVO createReqVO, Integer type) {
        ...
        // 3. 保存 ACL 授权主体配置
        savePrincipalTypes(role.getId(), createReqVO.getPrincipalTypes());
    ...
    public void deleteRole(Long id) {
        ...
        // 2.3 删除 ACL 授权主体配置
        aclPrincipalTypeConfigService.deleteByOwner(AclPrincipalTypeOwnerType.ROLE, id);
    ...
    public void deleteRoleList(List<Long> ids) {
        ...
        // 2.3 删除 ACL 授权主体配置
        ids.forEach(id -> aclPrincipalTypeConfigService.deleteByOwner(AclPrincipalTypeOwnerType.ROLE, id));
    }
     ...
     * 保存角色的 ACL 授权主体配置
     */
    private void savePrincipalTypes(Long roleId, Set<String> principalTypes) {
        ...
        aclPrincipalTypeConfigService.savePrincipalTypes(AclPrincipalTypeOwnerType.ROLE, roleId, types);
    }
